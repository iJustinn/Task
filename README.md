...
Current app version: **0.4.5 (build 1)**

## Screenshots

<p align="center">
  <img src="Screenshots/01-v0.4.0.PNG" alt="Board home" width="32%"/>
  <img src="Screenshots/02-v0.4.0.PNG" alt="Board switcher" width="32%"/>
  <img src="Screenshots/03-v0.4.0.PNG" alt="Task editor" width="32%"/>
</p>
<p align="center">
  <img src="Screenshots/04-v0.4.0.PNG" alt="Calendar picker" width="32%"/>
  <img src="Screenshots/05-v0.4.0.PNG" alt="Settings" width="32%"/>
  <img src="Screenshots/06-v0.4.0.PNG" alt="Widget" width="32%"/>
</p>

## Highlights

- **Multiple boards.** Fresh installs ship with Personal 🏃, Study 🎓, and Work 💼 — each with its own groups, tags, tasks, and defaults. Switch from the folder button in the bottom bar; long-press a tile in the switcher to reorder, or drag onto the trash zone to delete.
...
- **Local reminders.** Per-task toggle. Time-of-day is configurable per board (Settings → Default → Reminder Time, default 9:00).
- **Search.** Tap the search field to find tasks by title, notes, tag, or group across the active board.
